...
pub fn decode_u64_from_array_ref(buf: &[u8; 9]) -> (u64, usize) {
...
mod tests {
    ...
    fn test_decoding() {
        assert_eq!(OFFSET0, 0);
        assert_eq!(decode_u64_from_array_ref(&[
